...
self.addEventListener("fetch",e=>{
  ...
  if(e.request.url.includes("api.groq.com")||e.request.url.includes("generativelanguage.googleapis.com")||e.request.url.includes("api.openai.com")) return;
